function [X,T,STD_ERR,siz] = curva_media_repmat(DEP,INDEP,filt,plotflag)

% DEP is a matrix, INDEX a vector; repmats the vectors and computes the mean and std
